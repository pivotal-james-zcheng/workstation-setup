...
echo "alias dcia='git duet-commit --amend --reset-author'" >> ~/.bash_it/aliases/enabled/general.aliases.bash
echo "alias dciane='git duet-commit --amend --reset-author --no-edit'" >> ~/.bash_it/aliases/enabled/general.aliases.bash
